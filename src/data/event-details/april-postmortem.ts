...
export const detail: EventDetail = {
  ...
  receipts: [
    ...
    "Laurenzo's March usage would have cost ~$42,121/month at Bedrock on-demand rates, versus her ~$400 subscription, about 105x.",
  ...
  reactions: [
    {
      ...
      meta: "AMD Senior Director; quoted in Brent W. Peterson's Medium piece",
      quote:
